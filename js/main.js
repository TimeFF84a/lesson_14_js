...
let weekFn = function (n) {
  switch (n) {
    case 1: return 'Понедельник';    case 2: return 'Вторник';    case 3: return 'Среда';    case 4: return 'Четверг';    case 5: return 'Пятница';    case 6: return 'Суббота';    case 7: return 'Воскресенье';    default: return null;
  }
}
 ...
 *
 */
let mainFunc = function (a, b, func) {
 ...
 */
console.log(mainFunc(1, 2, cbRandom)); // целые числа в диапазоне 2..5
